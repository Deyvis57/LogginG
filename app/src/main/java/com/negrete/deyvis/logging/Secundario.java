 ...
 */
public class Secundario  extends AppCompatActivity implements View.OnClickListener {
    EditText id, nombre, cantidad,contenido,valor;
    Button agregar, modificar, eliminar, ver, limpiar, buscar;
    Integer contContactos=0;

    private static final String FIREBASE_URL="https://materiales.firebaseio.com/";
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.bAgregar:
                Toast.makeText(Secundario.this, "Agregar", Toast.LENGTH_SHORT).show();
